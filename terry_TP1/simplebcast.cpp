...
int simple_bcast(std::vector<int> *vector, int myRank, int nProc)
{
  MPI_Status status;
...
{  
 ...
 // MPI Setup
  ...
  // Broadcast using Simple Broadcast Algorithm
  simple_bcast(&vector, myRank, nProc);
